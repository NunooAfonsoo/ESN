...
namespace Assets.Scripts.Camera
{
    public class SimpleCameraController : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            {
                var mouseMovement = GetInputLookRotation() * 0.02f * 5;
                if(invertY)
            ...
            // Translation
            var translation = GetInputTranslationDirection() * 0.02f;
            ...
            var positionLerpPct = 1f - Mathf.Exp((Mathf.Log(1f - 0.99f) / positionLerpTime) * 0.02f);
            var rotationLerpPct = 1f - Mathf.Exp((Mathf.Log(1f - 0.99f) / rotationLerpTime) * 0.02f);
