...
{
    class RemoteWorkBehaviourTree : Selector
    {
        public RemoteWorkBehaviourTree(Entity person, Home home, Transform homeDoor, Workplace workplace, Transform workplaceDoor, List<FreeTimePlace> freeTimepPlaces, Dictionary<FreeTimePlace, List<Transform>> freetimePlacesDoors, Hospital hospital, Transform hospitalDoor, Lab lab, Transform labDoor)
        {
            ...
            person.CurrentBehaviourTree = Entity.BehaviourTreeType.RemoteWork;
